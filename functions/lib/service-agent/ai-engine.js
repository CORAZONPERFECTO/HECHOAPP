...
exports.analyzeEvidenceAndDraftQuote = void 0;
...
async function analyzeEvidenceAndDraftQuote(imageUrl, ticketContext) {
    var _a, _b, _c, _d, _e;
    try {
        ...
        Context:
        Ticket Description: ${(ticketContext === null || ticketContext === void 0 ? void 0 : ticketContext.description) || 'No description provided'}
        Ticket Title: ${(ticketContext === null || ticketContext === void 0 ? void 0 : ticketContext.title) || 'Service Ticket'}
...
exports.analyzeEvidenceAndDraftQuote = analyzeEvidenceAndDraftQuote;
